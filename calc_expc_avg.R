#' @title Calculate POC flux at maximum annual MLD
#' @author Stevie Walker
#' @date 7/27/21
#' @description finds the short-term and long-term 20 year average and change in POC flux 
...
calc_expc_avg <- function(wd, nc.file, model.name, start.st, start.lt, lon.name, lat.name) {
...
expc_st <- array(expc_st, dim=c(dim(list_expc[[1]]), length(list_max)))
