#' @title Calculate time series of globally integrated POC flux change at 1000m
...
time_series_1000 <- function(wd, model.name, fut.name, his.name, area.name, lon.length, lat.length) {
  ...
  write.csv(df,paste0("~/senior_thesis/plotting_dataframes/time_series/",model.name,"_time_series_1000.csv"))
